...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('name','username', 'email', 'password', 'bio', 'avatar',  'is_active', 'is_admin', 'is_staff')
...
class UserAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email','username', 'name', 'password1', 'password2', 'is_admin', 'is_staff', 'is_active', 'groups', 'user_permissions')}
        ),
    )
    search_fields = ('email',)
    ordering = ('email',)
